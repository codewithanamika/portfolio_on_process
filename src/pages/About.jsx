...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Building tools that make a real difference in people's lives",
      icon: "🤝",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              A passionate developer from Nepal, crafting accessible and
              innovative solutions that bridge technology with human needs
            </p>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed">
                    I'm a developer from Nepal who discovered my passion for
                    creating
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed">
                    ...
                    <em>"How can technology be more accessible?"</em>
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed">
                    When I'm not coding, you'll find me designing random stuffs
                    in figma or listening to music.
                  </p>
                </div>
                    ...
                    <div className="h-3 bg-slate-700 rounded-full overflow-hidden">
                      <div
                        className={`h-full bg-gradient-to-r ${
                          skill.color
                        } rounded-full transform transition-all duration-1000 delay-${
                          index * 100
                        }`}
                ...
                {values.map((value, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-3 rounded-lg bg-gradient-to-r ${value.color} text-white text-2xl group-hover:scale-110 transition-transform duration-300`}
                      >
                        {value.icon}
                      </div>
                      <div>
      ...
      <footer className="bg-slate-950 text-gray-400 py-8 px-6 border-t border-slate-800 mt-20">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Anamika Regmi &mdash; Frontend
            Developer & React Enthusiast
          </p>
